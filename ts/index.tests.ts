// This file is very out-of-date - I don't even think this is used anywhere
// import * as firebase from '@firebase/testing'
import StorageManager from '@worldbrain/storex/ts'
import { StorageModule } from '@worldbrain/storex-pattern-modules/ts'
import { setupStorexTest } from '@worldbrain/storex-pattern-modules/ts/index.tests'
...
export async function withEmulatedFirestoreBackend<
    Modules extends { [name: string]: StorageModule } = {
